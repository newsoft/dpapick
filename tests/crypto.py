...
class CryptoTest(unittest.TestCase):
    ...
    def test_CryptSessionKeyXPVerif(self):
        m = ("f1cd9c3915428d12c0e9bf5ac0c44dda"
             "647e6e387118c09eb00a294e485a3f6e"
             "fe47f16686ad5f60fbd740164de87711"
             "6eb70d35445b22ddebdb02b0d55ee613").decode("hex")
        ...
        self.assertEquals(crypto.CryptSessionKeyXP(m, n, h, None, None, s), r)
        self.assertNotEquals(crypto.CryptSessionKeyWin7(m, n, h, None, None, s), r)

    def test_CryptSessionKeyXPEntropyVerif(self):
        m = ("d0c624a61e4080ac28ec07f33466581e"
             "c04980f26953aa940258dc4ced7fd545"
             "251208d88d6bac5c64b5cd69b4e21400"
             "93174f51ab07f0f5fb7a45462a2c00e4").decode("hex")
        ...
        self.assertEquals(crypto.CryptSessionKeyXP(m, n, h, e, None, s), r)
        self.assertNotEquals(crypto.CryptSessionKeyWin7(m, n, h, e, None, s), r)
    ...
    def test_CryptSessionKeyWin81EntropyVerif(self):
        m = ("c942b584a88a36f3ce8abe61a62d4036"
             "49dfdd8fd9b256a4a7ff64bfe2b60df8"
             "cb563be71d0d65f8be03ebdd76b4dba1"
             "68a9e3883fee758d2c4aeef040571cc2").decode("hex")
        ...
        self.assertNotEquals(crypto.CryptSessionKeyXP(m, n, h, e, None, s), r)
        self.assertEquals(crypto.CryptSessionKeyWin7(m, n, h, e, None, s), r)
